...
function getActionHandler(actionName: string, actionDescription: string, tools: any) {
    return async (
...
function composeActionContext(actionName: string, actionDescription: string, state: State): string {
